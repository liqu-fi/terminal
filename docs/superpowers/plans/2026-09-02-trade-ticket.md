...
## Состояние на 2026-09-02 — фаза закрыта

Задачи 1–10 закрыты, условия готовности фазы выполнены все. Задачи 1–9 приехали
в `main` как PR liqu-fi/terminal#40; задача 10 ждала релиза SDK и лежит в
PR #41.

`liq@0.44.0` выпущен: PR `liqcx/monorepo#728` смержен в `staging`, тег стоит на
коммите мержа `976cdffa`, workflow зелёный целиком — оба реестра отдают версию.
